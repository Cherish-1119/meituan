...
class Merchant(models.Model):
    ...
    address = models.CharField(max_length=200, verbose_name='商家店铺地址', null=False)
...
class Goods(models.Model):
    ...
    intro = models.CharField(max_length=200,verbose_name='商品介绍')
...
class Order(models.Model):
    ...
    # 还有优惠券和打折相应的数据库的设计？配送中需要配置一个骑手的平台
